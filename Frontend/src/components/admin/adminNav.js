  ...
  <div>
      <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bgTopNav fixed-top">
                <a class="navbar-brand h1 fw-bold" style={{fontSize:'25px'}} href="/Admin/Admin_Dashboard"><span className="text-black">DERANA</span><span className="text-danger"> &nbsp;NEWS</span></a>
                ...
                <nav class="navbar navbar-expand-lg navbar-light shadow-0">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item " style={{display:(userType === '"Editor"')? 'none' : 'inline' }}>
                                <a class="nav-link " style={{fontSize:'17px'}} href="Staff_Dashboard"  aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"> Staff </a>
                            </li> 
                            <li class="nav-item " >
                                <a class="nav-link " style={{fontSize:'17px'}} href="News"  aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"> News </a>
                            </li>
                            <li class="nav-item " style={{display:(userType === '"Editor"')? 'none' : 'inline' }}>
                                <a class="nav-link " style={{fontSize:'17px'}} href="News_category"  aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"> Categories </a>
                            </li>
                        </ul>
                    </div>
                </nav>
